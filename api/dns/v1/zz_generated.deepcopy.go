...
func (in *CNAMEGeneratorConfig) DeepCopy() *CNAMEGeneratorConfig {
	if in == nil {
		return nil
	}
	out := new(CNAMEGeneratorConfig)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DDNSGeneratorConfig) DeepCopyInto(out *DDNSGeneratorConfig) {
	*out = *in
	if in.ExtraApis != nil {
		in, out := &in.ExtraApis, &out.ExtraApis
